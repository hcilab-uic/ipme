...
//    if(!sage_thread_) {
//        sage_thread_ =
//            std::make_unique<std::thread>(&Sage_handler::internal_start,
//            this);
...
//    //    handler_map_.insert(create_default("0011",
...
//    //    handler_map_.insert(create_default("0014",
...
//    //    handler_map_.insert(create_default("0017",
//    "updateApplicationState")); handler_map_.insert(create_default("0018",
//    "startSagePointer")); handler_map_.insert(create_default("0019",
//    "createSagePointer")); handler_map_.insert(create_default("0020",
//    "setItemPosition")); handler_map_.insert(create_default("0021",
//    "setItemPositionAndSize")); handler_map_.insert(create_default("0022",
//    "deleteElement"));
