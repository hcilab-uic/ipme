...
namespace ipme::wb {
void Geometry::draw_circle(const Point& point, float radius, const Color& color)
{
...
void Geometry::draw_square(const Point& point, float side, const Color& color)
{
...
void Geometry::draw_eq_triangle(const Point& /* point */, float /* side */,
                                const Color& /* color */)
{
}

void Geometry::draw_line(const Point& point, float length, float angle,
                         const Color& color)
{
    glBegin(GL_LINES);
    glColor3f(color.r, color.g, color.b);
...
void Geometry::draw_segment(const Point& point, float length, float angle,
                            const Color& color)
{
