...
def test_nomality(data, name, alpha, msg_tag, remove_outliers):
...
def report_tests(single_ts, multi_ts, name, options, msg_tag):
    y, y_normal = test_nomality(single_ts, name, options.alpha,
                                'Single-screen', options.remove_outliers)
    x, x_normal = test_nomality(multi_ts, name, options.alpha,
                                'Multi-screen', options.remove_outliers)
